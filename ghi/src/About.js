    ...
    <div className="about">
      ...
      <ul className="detail">
        <li className="description">
          Welcome to GymBuddy, the ultimate fitness app that empowers you to
          craft your dream physique by selecting and exploring exercises
          tailored to your preferred difficulty level. At GymBuddy, we're
        ...
        <li className="description__secondary">
          Our mission at GymBuddy is to provide individuals with a dynamic and
          ...
          just starting your wellness journey, GymBuddy is here to guide you
          every step of the way.
        </li>
        <h2 className="about__heading--sub">How It Works</h2>
        <li className="description__secondary">
          GymBuddy makes achieving your fitness aspirations a breeze. Here's how
          ...
          intense challenge, GymBuddy has exercises suited to your needs. 2.
          ...
          exercises and complete workouts. GymBuddy provides you with insights
          into your journey, helping you stay motivated.
        </li>
        <li className="description__tertiary">
          Download GymBuddy today and embark on a new era of personalized
          fitness exploration.
        </li>

        <li className="description__tertiary">
          Shape Your Body. Shape Your Future. Shape Your Way with GymBuddy.
        </li>
